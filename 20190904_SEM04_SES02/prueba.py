...
Tarea:
- Ingresar 2 Valores
- Escoger operacion aritmética por operador o por texto
Archivos:
1. Solicitud de valores
2. Validación de los datos y operacion aritmética
3. Llamar funciones (principal)
Enviar al chat
"""